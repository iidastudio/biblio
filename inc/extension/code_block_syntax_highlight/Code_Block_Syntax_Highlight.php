...
class Code_Block_Syntax_Highlight {
  ...
  public function load_prism_js() {
    if( Helper::has_block_all('core/code') ) {
      ...
      wp_enqueue_script('js-prism', get_template_directory_uri().$this->dir_name.'prism.js', array('wp-i18n'), filemtime( get_template_directory().$this->dir_name.'prism.js' ), array('strategy' => 'defer') );
    }
  }
